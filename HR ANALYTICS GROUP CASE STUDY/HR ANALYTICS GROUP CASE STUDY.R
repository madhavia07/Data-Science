...
#-----------------------------------------------------------------------------
# Course 3 | HR ANALYTICS GROUP CASE STUDY
#-----------------------------------------------------------------------------
...
# We have 5 datasets, combining which we need to create 1 dataset on which we can perform analysis
...
# between in time and out time will help us to see if that variable is affecting our dependent variable or not
...
# Lets remove Education field life sciences
...
# Lets remove work life balance with level 4
...
# Lets remove distance from home more than 20 
...
# but according to our business case sensitivity should be on higher side, so making necessary changes to make adjustment
...
# -------------------------------------------------------------------
# FACTORS MODERATELY AFFECTING VARIABLES
# -------------------------------------------------------------------
